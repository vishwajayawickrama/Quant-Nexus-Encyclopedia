...
The tools developed here — entropy estimation, mutual information, transfer entropy, and the maximum entropy principle — recur throughout the encyclopedia. In **Module 08**, we turn to optimization theory, where information-theoretic regularizers (entropy penalties, KL constraints) play a central role in robust portfolio construction and machine learning for finance.
