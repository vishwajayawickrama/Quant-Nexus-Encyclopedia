...
| **Second-order cone** | $\{\, (\mathbf{x}, t) : \lVert\mathbf{x}\rVert_2 \leq t \,\}$ | Tracking error constraint |
...
*Next: [Module 07 — Information Theory & Entropy](../Foundations/07_information_theory.md)*
